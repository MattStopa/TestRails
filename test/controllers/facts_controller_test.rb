...
class FactsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fact" do
    assert_difference('Fact.count') do
      post facts_url, params: { fact: { headline: @fact.headline, links: @fact.links, published: @fact.published, summary: @fact.summary } }
    end
  ...
  test "should update fact" do
    patch fact_url(@fact), params: { fact: { headline: @fact.headline, links: @fact.links, published: @fact.published, summary: @fact.summary } }
